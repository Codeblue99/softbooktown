...
?>
	<section class="breadcrumb-section">
				...
				<div class="breadcrumb-contents">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><?php echo $store_name ?> </li>
						</ol>
					</nav>
				</div>
			</div>
		...
		<main class="inner-page-sec-padding-bottom">
            ...
            <?php
             $cn_book="select * from tbl_books where assign_bookstore_id='$bid'";
             ...
             ?>
				...
				<?php } ?>
				 ...
				 <?php
             $cn_book="select * from tbl_guestpaper where assign_bookstore_id='$bid'";
             $run_book=mysqli_query($con,$cn_book);
             while($row_book=mysqli_fetch_array($run_book))
             {
         ...
         $fg_sc="select * from tbl_schools where school_email='$school_email'";
             ...
             ?>
				...
				<?php } ?>
					 ...
					 <?php
             $cn_book="select * from tbl_notes where assign_bookstore_id='$bid'";
             $run_book=mysqli_query($con,$cn_book);
             while($row_book=mysqli_fetch_array($run_book))
             {
