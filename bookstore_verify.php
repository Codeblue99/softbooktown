...
{
	$uemail=$_GET['uemail'];
	$fg_c="select * from tbl_book_store where store_email='$uemail'";
				...
				<div class="breadcrumb-contents">
					<nav aria-label="breadcrumb">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">BookStore Verify</li>
						</ol>
					</nav>
				</div>
			</div>
					...
					<div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
						<form method="post">
							<div class="login-form">
								<h4 class="login-title">Verify BookStore Account</h4>
								<div class="row">
...
"Upload Your Book , Send a Quotation & Many More Feature And Earn Unlimited Money.." . "\r\n" . "\r\n" . "Regard : " . "\r\n" . "Team Soft Book Town ";
mail($uemail,$subject,$txt,$headers);


    $update="update tbl_book_store set verify_status='Active' where store_email='$uemail'";
    $run_update=mysqli_query($con,$update);

    echo "<script>alert('Verify Successfully')</script>";	
     echo "<script>window.open('bookstore_panel/bookstore_login.php','_self')</script>";
